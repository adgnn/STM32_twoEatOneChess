...
void DrawCB()
{
    ...
    DrawCBGrid();
    for(int i=0; i<6; i++){
        //遍历PlayerX->chessState[i]，若棋子没被吃掉，调用函数作棋子
        // 玩家1棋子用蓝色，玩家2棋子用绿色
...
void clearAll()
{
    LCD_DrawRect(0,0,320,240,WHITE);
}
```
...
void DrawCBGrid()
{
    ...
    // (240, 20) - (240, 221)
    /// (80, 220) - (240, 221)
    LCD_DrawRect(80,20,240,19,RED);
    LCD_DrawRect(80,20,80,219,RED);
    LCD_DrawRect(240,20,240,221,RED);
    LCD_DrawRect(80,220,240,221,RED);
    /* 内线 */
    // 横线
    // (80, 60) - (240, 61)
    // (80, 100) - (240, 101)
    // (80, 140) - (240, 141)
    // (80, 180) - (240, 181)
    LCD_DrawRect(80,60,240,61,RED);
    LCD_DrawRect(80,100,240,101,RED);
    LCD_DrawRect(80,140,240,141,RED);
    LCD_DrawRect(80,180,240,181,RED);
    // 竖线
    // (120, 20) - (121, 220)
    // (160, 20) - (161, 220)
    // (200, 20) - (201, 220)
    LCD_DrawRect(120,20,121,220,RED);
    LCD_DrawRect(160,20,161,220,RED);
    LCD_DrawRect(200,20,201,220,RED);
}
    ...
    */
    switch(num){
        ...
        case 3:
            ...
            LCDY = CBX[y];
            LCD_DrawRect(LCDX+10, LCDY+20, LCDX+30, LCDY+21, GRB);
            LCD_DRAWRect(LCDX+15, LCDY+10, LCDX+16, LCDY+30, GRB);
            LCD_DRAWRect(LCDX+25, LCDY+10, LCDX+26, LCDY+30, GRB);
        case 4:
            // 4号棋子
            // 画一个“”
        case 5:
